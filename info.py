...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://xxsilentxx823:xxsilentxx823@cluster0.8lzaba9.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "xxsilentxx823")
...
URL = "https://moviefilterbo.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviefilterbo.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviefilterbo.onrender.com/".format(FQDN)
else:
    URL = "https://moviefilterbo.onrender.com/".format(FQDN)
